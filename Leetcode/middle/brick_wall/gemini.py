def find_min_crossed_bricks(wall):
  """
  This function takes a 2D list representing a brick wall as input and returns the minimum number of bricks that can be crossed by a vertical line drawn from the top to the bottom of the wall.

  Args:
      wall: A 2D list where each sublist represents a row of bricks in the wall. The value at each index in the sublist represents the width of a brick in that row.
